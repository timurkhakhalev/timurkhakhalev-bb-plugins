...
| --- | --- | --- |
| [Browser Annotate](./plugins/browser-annotate) | Add comments to elements in a native BB Browser tab and send them with screenshots to the current chat. | Preparing for first release |
...
```sh
bb plugin install git:github.com/timurkhakhalev/timurkhakhalev-bb-plugins@main --plugin browser-annotate
```
